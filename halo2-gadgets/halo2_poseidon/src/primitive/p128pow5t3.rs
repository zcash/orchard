use pasta_curves::{arithmetic::Field, pallas::Base as Fp, vesta::Base as Fq};
...
mod tests {
    ...
    fn permute_test_vectors() {
        {
            ...
            for tv in crate::primitive::test_vectors::fp::permute() {
                let mut state = [
...

        {
            ...
            for tv in crate::primitive::test_vectors::fq::permute() {
                let mut state = [
    ...
    fn hash_test_vectors() {
        ...
        for tv in crate::primitive::test_vectors::fq::hash() {
            let message = [
